                ...
                {isLoading ? (
                  ...
                  <div className="flex justify-center">
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      className="w-80 h-80 md:w-[32rem] md:h-[32rem] lg:w-[36rem] lg:h-[36rem] xl:w-[40rem] xl:h-[40rem] rounded-full overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105"
                    >
                      <img
